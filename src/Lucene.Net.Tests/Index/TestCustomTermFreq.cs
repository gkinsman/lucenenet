...
namespace Lucene.Net.Index
{
    public class TestCustomTermFreq : LuceneTestCase
    {
        private sealed class CannedTermFreqs : TokenStream
        {
            ...
            private readonly ITermFrequencyAttribute termFreqAtt = addAttribute(TermFrequencyAttribute.class);
        ...
        public void testSingletonTermsOneDoc() throws Exception { Directory dir = newDirectory();
        ...
        Field field = new Field("field",
            new Index.CannedTermFreqs(new String[] {"foo", "bar"},
                new int[] {42, 128}),
            fieldType);
    ...
    new CannedTermFreqs(new String[] {
        "foo", "bar"
    },
    ...
    Field field = new Field("field",
        new Index.CannedTermFreqs(new String[] {"foo", "bar", "foo", "bar"},
...
assertEquals("field \"field\": cannot index term vector positions while using custom TermFrequencyAttribute", e.
getMessage());
IOUtils.close(w, dir);
}
...
private readonly static NeverForgetsSimilarity INSTANCE = new NeverForgetsSimilarity();
